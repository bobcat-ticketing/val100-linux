...
/* hid descriptor for bgr750  */
static struct hidg_func_descriptor bgr750_hid_data = {
...
static struct platform_device bgr750_hid = {
	.name			= "hidg",
	.id			= 0,
	.num_resources		= 0,
	.resource		= 0,
	.dev.platform_data	= &bgr750_hid_data,
};
...
static void __init imx6q_opp_init(void)
{
	...
	if (IS_ENABLED(CONFIG_MX6_VPU_352M) || IS_ENABLED(CONFIG_MX6_VPU_328M)) {
		if (dev_pm_opp_disable(cpu_dev, 396000000))
			...
			pr_info("remove 396MHz OPP for VPU running at 352/328 MHz!\n");
	}
put_node:
	of_node_put(np);
}
